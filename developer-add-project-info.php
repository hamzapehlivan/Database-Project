...
if( $end_date == null ){
	$insert_project_info = " insert into projectinfo values( '$profileid', '$project_title', '$start_date', null, '$project_type', '$description', '$project_link' ) ";
} else {
	$insert_project_info = " insert into projectinfo values( '$profileid', '$project_title', '$start_date', '$end_date', '$project_type', '$description', '$project_link' ) "; 	
}
