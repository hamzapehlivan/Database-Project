...
if( $end_date == null ){
	$insert_education_info = " insert into educationinfo values( '$profile_id', '$institution_name', '$start_date', null, '$isGraduted', '$cgpa', '$description' ) "; 	
} else {
	$insert_education_info = " insert into educationinfo values( '$profile_id', '$institution_name', '$start_date', '$end_date', '$isGraduted', '$cgpa', '$description' ) "; 	
}
