...
if( $_POST["action"] == "update"){
	$update_project = " update projectinfo set end_date='$end_date', project_type='$project_type', description='$description', $project_link='$$project_link' where profile_id='$profileid' and project_title='$project_title' and start_date='$start_date' ";
	mysqli_query($conn, $update_project);
	$_SESSION["edit_project_message"] = 'Your information has been updated successfully!';
} else {
	$delete_project = " delete from projectinfo where profile_id='$profileid' and project_title='$project_title' and start_date='$start_date' ";
